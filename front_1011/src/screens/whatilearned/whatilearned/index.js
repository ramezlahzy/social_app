...
const App = () => {
  const WhatIlearnedWithFriend = () => {
    return(
      <WhatIlearnedList flag={1}></WhatIlearnedList>  //flag = 1 show sharewith friends
    )
  }
  const WhatIlearnedWithWorldWide = () => { 
    return(
      <WhatIlearnedList flag={2}></WhatIlearnedList> //flag = 2 show sharewith worldwide
    )
  }
  const WhatIlearnedWithAll = () => {
    return(
      <WhatIlearnedList flag={3}></WhatIlearnedList>   //flag = 3 show sharewith all
    )
  }
  const WhatIlearnedCreateComponent = () => {
    return(
      <WhatIlearnedCreate></WhatIlearnedCreate>
    )
  }
  return (
    <Tab.Navigator tabBar={(props) => <CustomTabBar {...props} />}>
      <Tab.Screen name="FRIENDS" component={WhatIlearnedWithFriend} />
      <Tab.Screen name="WORLDWIDE" component={WhatIlearnedWithWorldWide} />
      <Tab.Screen name="ALL" component={WhatIlearnedWithAll} />
      <Tab.Screen name="ADD+" component={WhatIlearnedCreateComponent} />
    </Tab.Navigator>
  );
};
